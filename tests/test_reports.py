...
from src.reports import category_expenses_report, weekday_expenses_report, weekday_vs_weekend_expenses_report
...
def test_category_expenses_report(mock_logger: Any, sample_df: pd.DataFrame) -> None:
...
@patch("src.reports.reports_logger")
def test_weekday_expenses_report(mock_logger: Any, sample_df: pd.DataFrame) -> None:
    start_date = "2020-01-01"
...
@patch("src.reports.reports_logger")
def test_weekday_vs_weekend_expenses_report(mock_logger: Any, sample_df: pd.DataFrame) -> None:
    start_date = "2020-01-01"
